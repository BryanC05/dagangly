                      ...
                      <div className="order-body">
                        ...
                        <div className="order-footer">
                          <div className="order-meta">
                            ...
                            {/* Track Delivery Live with Biteship */}
                                ...
                                <div className="flex items-start justify-between">
                                  <div className="flex-1">
                                    ...
                                    <p className="text-xs text-blue-700 dark:text-blue-300 mb-2">
                                      Tracking: <span className="font-mono font-medium">{order.shipmentTrackingId}</span>
                                    </p>
                                    {order.shipmentStatus && (
                                      <span className={`inline-block px-2 py-1 rounded text-xs font-medium ${
                                        order.shipmentStatus === 'delivered' ? 'bg-green-100 text-green-800' :
                                        order.shipmentStatus === 'in_transit' ? 'bg-blue-100 text-blue-800' :
                                        order.shipmentStatus === 'out_for_delivery' ? 'bg-purple-100 text-purple-800' :
                                        order.shipmentStatus === 'pending' ? 'bg-yellow-100 text-yellow-800' :
                                  ...
                                  >
                                    <a href={`/track/${order.shipmentTrackingId}`} target="_blank" rel="noopener noreferrer">
