    ...
    <div className="min-h-screen bg-gray-50 dark:bg-[#0a0a0a] text-gray-900 dark:text-gray-100 pb-20 font-sans">
      ...
      <div className="max-w-7xl mx-auto p-4 md:p-8">
        ...
        <Tabs defaultValue="overview" className="w-full space-y-6">
          <TabsList className="flex border-b border-border bg-transparent p-0 gap-6 h-auto mb-8 rounded-none justify-start w-full overflow-x-auto no-scrollbar">
            <TabsTrigger 
              value="overview" 
              className="border-b-2 border-transparent rounded-none px-1 pb-3 pt-2 text-sm font-bold text-muted-foreground hover:text-foreground data-[state=active]:border-primary data-[state=active]:bg-transparent data-[state=active]:text-primary data-[state=active]:shadow-none cursor-pointer"
            >
              Overview
            </TabsTrigger>
            <TabsTrigger 
          ...
          <TabsContent value="inventory" className="outline-none">
            <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-gray-800 rounded-xl shadow-sm overflow-hidden">
              <div className="p-6 border-b border-gray-200 dark:border-gray-800 flex justify-between items-center">
                ...
                <Link to="/seller/add-product" className="inline-flex items-center justify-center gap-2 px-4 py-2 text-xs font-bold bg-primary text-primary-foreground rounded-xl shadow-lg shadow-primary/20 hover:scale-[1.02] active:scale-[0.98] transition-all">
          ...
          <TabsContent value="orders" className="outline-none">
            {orders && orders.length > 0 ? (
              ...
              <div className="bg-white dark:bg-[#121212] border border-gray-200 dark:border-gray-800 rounded-xl p-12 text-center shadow-sm">
          ...
          {/* AI Advisor & Tools Tab Content */}
          <TabsContent value="advisor" className="space-y-8 outline-none">
