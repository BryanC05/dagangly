...
export default function ProfileScreen({ navigation, route }) {
    ...
    const menuItems = useMemo(() => [
        ...
        { icon: 'wallet-outline', label: t.myWallet || 'My Wallet', onPress: () => navigation.navigate('Wallet'), color: '#10b981' },
        { icon: 'card-outline', label: t.installments || 'Installments', onPress: () => navigation.navigate('Installments'), color: '#6366f1' },
        { icon: 'videocam-outline', label: t.videoCall || 'Video Call', onPress: () => navigation.navigate('VideoCall'), color: '#f97316' },
